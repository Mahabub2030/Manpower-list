...
//                     // Apply text wrapping for header row of the 10th column
//                     doc.content[1].table.headerRows = 1; // Set header rows to 1
//                     doc.content[1].table.headerRows.forEach(function(header) {
//                         header[9].alignment = 'center'; // 10th column alignment
//                         header[9].wrap = 'normal'; // Enable text wrapping for 10th column header
//                     });
//                 }
//             }, 
//             'print', 
